...
fill(240);
text("About me",width*(x1+l1+t1)+MX*0.01,height*(y1+0.1+g1)+MY*0.01);
fill(10);
text("About me",width*(x1+l1+t1)+MX*0.01+1,height*(y1+0.1+g1)+MY*0.01+2);

fill(240);
text("Sound",width*(x2+l2+t2)+MX*0.01,height*(y2+0.1+g2)+MY*0.01);
fill(10);
text("Sound",width*(x2+l2+t2)+MX*0.01+1,height*(y2+0.1+g2)+MY*0.01+2);

fill(240);
text("Installations",width*(x3+l3+t3)+MX*0.01,height*(y3+0.1+g3)+MY*0.01);
fill(10);
text("Installations",width*(x3+l3+t3)+MX*0.01,height*(y3+0.1+g3)+MY*0.01+2);

fill(240);
text("Contact",width*(x4+l4+t4)+MX*0.01,height*(y4+0.1+g4)+MY*0.01);
fill(10);
text("Contact",width*(x4+l4+t4)+MX*0.01+1,height*(y4+0.1+g4)+MY*0.01+2);
